...
/// Production `AuthRepository` backed by Supabase.
///
/// LAYER RULE: this is the ONLY auth file that imports
/// `supabase_flutter`. Everything else in `features/auth/` (bloc,
/// pages, etc.) goes through the `AuthRepository` interface.
///
...
class SupabaseAuthRepository implements AuthRepository {
  ...
  /// session synchronously (no deep-link round-trip).
  @override
